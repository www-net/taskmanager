...
class SiteMenu extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
const createTaskEditTemplate = (task, options = {}) => {
  ...
  const isBlockSaveButton = (isDateShowing && isRepeatingTask) ||
    (isRepeatingTask && !Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["isRepeating"])(activeRepeatingDays)) ||
    !isAllowableDescriptionLength(description);

  const date = (isDateShowing && dueDate) ? Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["formatDate"])(dueDate) : ``;
  const time = (isDateShowing && dueDate) ? Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["formatTime"])(dueDate) : ``;

  const repeatClass = isRepeatingTask ? `card--repeat` : ``;
  const deadlineClass = isExpired ? `card--deadline` : ``;

  const colorsMarkup = createColorsMarkup(_const_js__WEBPACK_IMPORTED_MODULE_0__["COLORS"], color);
  const repeatingDaysMarkup = createRepeatingDaysMarkup(_const_js__WEBPACK_IMPORTED_MODULE_0__["DAYS"], activeRepeatingDays);
...
const parseFormData = (formData) => {
  const repeatingDays = _const_js__WEBPACK_IMPORTED_MODULE_0__["DAYS"].reduce((acc, day) => {
    acc[day] = false;
    return acc;
  }, {});
...
class TaskEdit extends _abstract_smart_component_js__WEBPACK_IMPORTED_MODULE_2__["default"] {
  constructor(task) {
    super();
    this._task = task;
...
const createTaskTemplate = (task) => {
  ...
  const isExpired = dueDate instanceof Date && Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["isOverdueDate"])(dueDate, new Date());
  const isDateShowing = !!dueDate;

  const date = isDateShowing ? Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["formatDate"])(dueDate) : ``;
  const time = isDateShowing ? Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["formatTime"])(dueDate) : ``;
...
class Task extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_1__["default"] {
  constructor(task) {
    super();
    this._task = task;
  }
...
class Tasks extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
/* harmony import */ var _components_load_more_button__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../components/load-more-button */ "./src/components/load-more-button.js");
...
/* harmony import */ var _components_no_tasks__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/no-tasks */ "./src/components/no-tasks.js");
...
/* harmony import */ var _task__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./task */ "./src/controllers/task.js");
...
const renderTasks = (taskListElement, tasks, onDataChange, onViewChange) => {
  ...
  return tasks.map((task) => {
    const taskController = new _task__WEBPACK_IMPORTED_MODULE_5__["default"](taskListElement, onDataChange, onViewChange);

    taskController.render(task, _task__WEBPACK_IMPORTED_MODULE_5__["Mode"].DEFAULT);
...
const getSortedTasks = (tasks, sortType, from, to) => {
  ...
  switch (sortType) {
    case _components_sort__WEBPACK_IMPORTED_MODULE_3__["SortType"].DATE_UP:
      sortedTasks = showingTasks.sort((a, b) => a.dueDate - b.dueDate);
      break;
    case _components_sort__WEBPACK_IMPORTED_MODULE_3__["SortType"].DATE_DOWN:
      sortedTasks = showingTasks.sort((a, b) => b.dueDate - a.dueDate);
      break;
    case _components_sort__WEBPACK_IMPORTED_MODULE_3__["SortType"].DEFAULT:
...
class BoardController {
  constructor(container, tasksModel) {
    ...
    this._noTasksComponent = new _components_no_tasks__WEBPACK_IMPORTED_MODULE_2__["default"]();
    this._sortComponent = new _components_sort__WEBPACK_IMPORTED_MODULE_3__["default"]();
    this._tasksComponent = new _components_tasks__WEBPACK_IMPORTED_MODULE_1__["default"]();
    this._loadMoreButtonComponent = new _components_load_more_button__WEBPACK_IMPORTED_MODULE_0__["default"]();
  ...
  render() {
    ...
    if (isAllTasksArchived) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_4__["render"])(container, this._noTasksComponent);
      return;
    }

    Object(_utils_render__WEBPACK_IMPORTED_MODULE_4__["render"])(container, this._sortComponent);
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_4__["render"])(container, this._tasksComponent);
  ...
  createTask() {
    ...
    this._creatingTask = new _task__WEBPACK_IMPORTED_MODULE_5__["default"](taskListElement, this._onDataChange, this._onViewChange);
    this._creatingTask.render(_task__WEBPACK_IMPORTED_MODULE_5__["EmptyTask"], _task__WEBPACK_IMPORTED_MODULE_5__["Mode"].ADDING);
  }
  ...
  _renderLoadMoreButton() {
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_4__["remove"])(this._loadMoreButtonComponent);
    ...
    const container = this._container.getElement();
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_4__["render"])(container, this._loadMoreButtonComponent);
  ...
  _onDataChange(taskController, oldData, newData) {
    if (oldData === _task__WEBPACK_IMPORTED_MODULE_5__["EmptyTask"]) {
      this._creatingTask = null;
      ...
      if (newData === null) {
        ...
        taskController.render(newData, _task__WEBPACK_IMPORTED_MODULE_5__["Mode"].DEFAULT);
...
class FilterController {
  constructor(container, tasksModel) {
    ...
    this._activeFilterType = _const__WEBPACK_IMPORTED_MODULE_1__["FilterType"].ALL;
  ...
  render() {
    ...
    const filters = Object.values(_const__WEBPACK_IMPORTED_MODULE_1__["FilterType"]).map((filterType) => {
      return {
        name: filterType,
        count: Object(_utils_filter__WEBPACK_IMPORTED_MODULE_2__["getTasksByFilter"])(allTasks, filterType).length,
        checked: filterType === this._activeFilterType,
      };
    });
    const oldComponent = this._filterComponent;
    this._filterComponent = new _components_filter__WEBPACK_IMPORTED_MODULE_0__["default"](filters);
    this._filterComponent.setFilterChangeHandler(this._onFilterChange);
    if (oldComponent) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_3__["replace"])(this._filterComponent, oldComponent);
    } else {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_3__["render"])(container, this._filterComponent);
    }
  }
...
const EmptyTask = {
  ...
  color: _const__WEBPACK_IMPORTED_MODULE_2__["COLOR"].BLACK,
  isFavorite: false,
  isArchive: false,
};
...
class TaskController {
  ...
  render(task, mode) {
    ...
    this._taskComponent = new _components_task__WEBPACK_IMPORTED_MODULE_0__["default"](task);
    this._taskEditComponent = new _components_task_edit__WEBPACK_IMPORTED_MODULE_1__["default"](task);
    ...
    if (oldTaskEditComponent && oldTaskComponent) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_3__["replace"])(this._taskComponent, oldTaskComponent);
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_3__["replace"])(this._taskEditComponent, oldTaskEditComponent);
      this._replaceEditToTask();
    } else {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_3__["render"])(this._container, this._taskComponent);
    }
  }
  ...
  destroy() {
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_3__["remove"])(this._taskEditComponent);
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_3__["remove"])(this._taskComponent);
  ...
  _replaceEditToTask() {
    ...
    if (document.contains(this._taskEditComponent.getElement())) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_3__["replace"])(this._taskComponent, this._taskEditComponent);
    }
  ...
  _replaceTaskToEdit() {
    this._onViewChange();
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_3__["replace"])(this._taskEditComponent, this._taskComponent);
...
/* harmony import */ var _controllers_board__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./controllers/board */ "./src/controllers/board.js");
/* harmony import */ var _controllers_filter__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./controllers/filter */ "./src/controllers/filter.js");
/* harmony import */ var _components_statistics__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/statistics */ "./src/components/statistics.js");
/* harmony import */ var _components_site_menu__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/site-menu */ "./src/components/site-menu.js");
/* harmony import */ var _models_tasks__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./models/tasks */ "./src/models/tasks.js");
...
const siteMenuComponent = new _components_site_menu__WEBPACK_IMPORTED_MODULE_4__["default"]();

Object(_utils_render__WEBPACK_IMPORTED_MODULE_7__["render"])(siteHeaderElement, siteMenuComponent, _utils_render__WEBPACK_IMPORTED_MODULE_7__["RenderPosition"].BEFOREEND);

const tasks = Object(_mock_task__WEBPACK_IMPORTED_MODULE_6__["generateTasks"])(TASK_COUNT);
const tasksModel = new _models_tasks__WEBPACK_IMPORTED_MODULE_5__["default"]();
tasksModel.setTasks(tasks);

const filterController = new _controllers_filter__WEBPACK_IMPORTED_MODULE_2__["default"](siteMainElement, tasksModel);
filterController.render();

const boardComponent = new _components_board__WEBPACK_IMPORTED_MODULE_0__["default"]();
Object(_utils_render__WEBPACK_IMPORTED_MODULE_7__["render"])(siteMainElement, boardComponent);

const boardController = new _controllers_board__WEBPACK_IMPORTED_MODULE_1__["default"](boardComponent, tasksModel);
...
const statisticsComponent = new _components_statistics__WEBPACK_IMPORTED_MODULE_3__["default"]({tasks: tasksModel, dateFrom, dateTo});
Object(_utils_render__WEBPACK_IMPORTED_MODULE_7__["render"])(siteMainElement, statisticsComponent, _utils_render__WEBPACK_IMPORTED_MODULE_7__["RenderPosition"].BEFOREEND);
statisticsComponent.hide();

siteMenuComponent.setOnChange((menuItem) => {
  switch (menuItem) {
    case _components_site_menu__WEBPACK_IMPORTED_MODULE_4__["MenuItem"].NEW_TASK:
      siteMenuComponent.setActiveItem(_components_site_menu__WEBPACK_IMPORTED_MODULE_4__["MenuItem"].TASKS);
      statisticsComponent.hide();
      boardController.show();
      boardController.createTask();
      break;
    case _components_site_menu__WEBPACK_IMPORTED_MODULE_4__["MenuItem"].STATISTICS:
      boardController.hide();
      statisticsComponent.show();
      break;
    case _components_site_menu__WEBPACK_IMPORTED_MODULE_4__["MenuItem"].TASKS:
      statisticsComponent.hide();
      boardController.show();
      break;
  }
...
const getOverdueTasks = (tasks, date) => {
  return tasks.filter((task) => {
    ...
    return Object(_common__WEBPACK_IMPORTED_MODULE_1__["isOverdueDate"])(dueDate, date);
  });
};

// Получение повторяющихся задач
const getRepeatingTasks = (tasks) => {
  return tasks.filter((task) => Object(_common__WEBPACK_IMPORTED_MODULE_1__["isRepeating"])(task.repeatingDays));
};

// Получение задач за сегодняшний день
const getTasksInOneDay = (tasks, date) => {
  return tasks.filter((task) => Object(_common__WEBPACK_IMPORTED_MODULE_1__["isOneDay"])(task.dueDate, date));
};
...
const getTasksByFilter = (tasks, filterType) => {
  ...
  switch (filterType) {
    case _const__WEBPACK_IMPORTED_MODULE_0__["FilterType"].ALL:
      return getNotArchiveTasks(tasks);
    case _const__WEBPACK_IMPORTED_MODULE_0__["FilterType"].ARCHIVE:
      return getArchiveTasks(tasks);
    case _const__WEBPACK_IMPORTED_MODULE_0__["FilterType"].FAVORITES:
      return getFavoriteTasks(getNotArchiveTasks(tasks));
    case _const__WEBPACK_IMPORTED_MODULE_0__["FilterType"].OVERDUE:
      return getOverdueTasks(getNotArchiveTasks(tasks), nowDate);
    case _const__WEBPACK_IMPORTED_MODULE_0__["FilterType"].REPEATING:
      return getRepeatingTasks(getNotArchiveTasks(tasks));
    case _const__WEBPACK_IMPORTED_MODULE_0__["FilterType"].TODAY:
